...
export const FollowingCard = ({
  ...
  return (
    <div className="flex justify-between items-center w-full p-4 bg-white rounded shadow">
      {/* 프로필 클릭 영역 */}
      <div
        className="flex min-w-0 items-center gap-4 cursor-pointer"
        onClick={handleProfileClick}
      >
        <div className="w-14 h-14 shrink-0 rounded-full bg-slate-200 flex items-center justify-center text-[#5FBDFF] text-lg font-medium">
          {initial}
        </div>
